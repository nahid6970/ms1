...
ProwlarrDB_dst        ="C:/Users/nahid/OneDrive/backup/@mklink/prowlarr/prowlarr.db"
ProwlarrDB_src        ="C:/ProgramData/Prowlarr/prowlarr.db"
RadarrDB_dst        ="C:/Users/nahid/OneDrive/backup/@mklink/radarr/radarr.db"
RadarrDB_src        ="C:/ProgramData/Radarr/radarr.db"
SonarrDB_dst        ="C:/Users/nahid/OneDrive/backup/@mklink/sonarr/sonarr.db"
SonarrDB_src        ="C:/ProgramData/Sonarr/sonarr.db"
...
def git_backup(event):
    subprocess.Popen(["Start", "pwsh",  "-NoExit", "-Command", "& {$host.UI.RawUI.WindowTitle='GiTSync' ; C:\\ms1\\scripts\\Github\\ms1u.ps1 ; C:\\ms1\\scripts\\Github\\ms2u.ps1 ; cd ~}"], shell=True)
