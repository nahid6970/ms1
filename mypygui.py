...
ShadowFight3_lb.bind( "<Button-3>", lambda event=None: run_command(r'python C:\ms1\scripts\shadowFight3\CoC.py'))
ShadowFight3_lb.bind("<Control-Button-3>",lambda event=None: run_command('code C:\\ms1\\scripts\\shadowFight3\\CoC.py'))
