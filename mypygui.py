...
AppManagement_bt.bind("<Button-1>",lambda event:subprocess.Popen([r"cmd /c start C:\ms1\applist.py"], shell=True))
AppManagement_bt.bind("<Control-Button-1>",lambda event:subprocess.Popen([r"cmd /c code C:\ms1\applist.py"], shell=True))
