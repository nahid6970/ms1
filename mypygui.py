...
wifi_reboot_lb.bind("<Button-1>",lambda event:subprocess.Popen(["cmd /c C:\\msBackups\\Autohotkey\\UIA_v2\\wifi_reboot.ahk"], shell=True))
wifi_reboot_lb.bind("<Control-Button-1>",lambda event:subprocess.Popen(["cmd /c code C:\\msBackups\\Autohotkey\\UIA_v2\\wifi_reboot.ahk"], shell=True))
