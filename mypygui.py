...
ShadowFight3_lb.bind( "<Button-3>", lambda event=None: run_command(r'python C:\ms1\scripts\CoC\clash_of_clan.py'))
ShadowFight3_lb.bind("<Control-Button-3>",lambda event=None: run_command(r'code C:\ms1\scripts\CoC\clash_of_clan.py'))
...
ollama_lb.bind( "<Button-1>", lambda event=None: run_command(r'python C:\ms1\test_project\ollama-chat-app\kill_port_8000.py'))
