...
ShadowFight3_lb.bind("<Button-1>", lambda event=None: subprocess.Popen('cmd /k start powershell -ExecutionPolicy Bypass -NoExit -Command "python C:\\ms1\\SH3\\SH3V2.py"'))
