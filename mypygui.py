...
bkup.bind      ("<Button-1>", lambda event: subprocess.Popen(["powershell", "Start-Process", "cmd", "-ArgumentList", "/k C:\\ms1\\scripts\\Github\\ms1u.ps1 ; C:\\ms1\\scripts\\Github\\ms2u.ps1"],shell=True))
STATUS_MS1.bind("<Button-1>", lambda event: show_git_changes("C:\\ms1"))
STATUS_MS2.bind("<Button-1>", lambda event: show_git_changes("C:\\ms2"))


"powershell", "Start-Process", "cmd","-ArgumentList",'"/k systeminfo"'
