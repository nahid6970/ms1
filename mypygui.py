...
ShadowFight3_lb.bind("<Button-1>", lambda event=None: subprocess.Popen('cmd /k start powershell -ExecutionPolicy Bypass -NoExit -Command "python C:\\ms1\\SH3\\sf3_PY.py"'))
ShadowFight3_lb.bind("<Control-Button-1>",lambda event=None:subprocess.Popen('cmd /c code C:\\ms1\\SH3\\sf3_PY.py'))
ShadowFight3_lb.bind("<Button-3>",lambda event=None:subprocess.Popen('cmd /c start C:\\ms1\\SH3\\sf3_AHK.py'))
ShadowFight3_lb.bind("<Control-Button-3>",lambda event=None:subprocess.Popen('cmd /c code C:\\ms1\\SH3\\sf3_AHK.py'))
...
LB_CPU.bind("<Button-1>",lambda event:subprocess.Popen(["cmd /c start C:\\ms1\\kp.ps1"], shell=True))
LB_CPU.bind("<Control-Button-1>",lambda event:subprocess.Popen(["cmd /c code C:\\ms1\\kp.ps1"], shell=True))
