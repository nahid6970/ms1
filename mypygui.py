...
LB_M = tk.Label(BOX_ROW_ROOT, bg="#FFFFFF", fg="#000000", width=" 2", height="1", relief="flat", highlightthickness=1, highlightbackground="#FFFFFF", padx=1, pady=0, text="࿘", font=("AGENCY", 10, "bold")) ; LB_M.pack(side="right", anchor="e", padx=(0,3), pady=(0,0)) ; LB_M.bind("<Button-1>", lambda event: toggle_window_size('࿘'))
LB_L = tk.Label(BOX_ROW_ROOT, bg="#000000", fg="#FFFFFF", width=" 2", height="1", relief="flat", highlightthickness=1, highlightbackground="#FFFFFF", padx=1, pady=0, text="▼", font=("AGENCY", 10, "bold")) ; LB_L.pack(side="right", anchor="e", padx=(0,3), pady=(0,0)) ; LB_L.bind("<Button-1>", lambda event: toggle_window_size('▼'))
LB_S = tk.Label(BOX_ROW_ROOT, bg="#FFFFFF", fg="#000000", width=" 2", height="1", relief="flat", highlightthickness=1, highlightbackground="#FFFFFF", padx=1, pady=0, text="◀", font=("ink free", 10, "bold")) ; LB_S.pack(side="right", anchor="e", padx=(0,3), pady=(0,0)) ; LB_S.bind("<Button-1>", lambda event: toggle_window_size('◀'))
