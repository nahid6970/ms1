...
LB_DUC         =tk.Label(ROOT3,bg="#000000",fg="#FFFFFF",height=0,width=5,relief="flat",highlightthickness=0,highlightbackground="#ffffff",anchor="w",font=("JetBrainsMono NFP",10,"bold"),text=""            )
...
uptime_label.pack  ( side="top", padx=(350,0), pady= (0,0)) ; uptime_label.bind("<Button-1>", None)
...
STATUS_MS1.pack    ( side="left",padx=(3,0), pady= (0,0)) ; STATUS_MS1.bind("<Button-1>", lambda event:show_git_changes("C:\\ms1"))
STATUS_MS2.pack    ( side="left",padx=(3,0), pady= (0,0)) ; STATUS_MS2.bind("<Button-1>", lambda event:show_git_changes("C:\\ms2"))
LB_K.pack          ( side="left",padx=(3,0), pady= (0,0)) ; LB_K.bind("<Button-1>", start_shortcut)
