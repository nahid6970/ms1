...
Sonarr_bt=tk.Label(ROOT1, text="\uf26c", height=0, width=0, bg="#000000", fg="#dad661", bd=0, highlightthickness=0, anchor="center", font=("Jetbrainsmono nfp", 14, "bold"))
Sonarr_bt.bind("<Button-1>",lambda event:(subprocess.Popen(["explorer","D:\\Downloads\\@Sonarr"],shell=True)))
...
Radarr_bt=tk.Label(ROOT1, text="\udb81\udfde", height=0, width=0, bg="#000000", fg="#74abff", bd=0, highlightthickness=0, anchor="center", font=("Jetbrainsmono nfp", 14, "bold"))
Radarr_bt.bind("<Button-1>",lambda event:(subprocess.Popen(["explorer","D:\\Downloads\\@Radarr"],shell=True)))
