...
chrome.storage.local.get(['excludedDomains'], (result) => {
    ...
    const isExcluded = excludedDomains.some(input => {
        ...
        // checking for colon, but ensuring we don't break IPv6 if that ever comes up (IPv6 uses colons)
        // Simple check: if it has a colon, and it's not enclosed in brackets (IPv6), take the part before it.
        // For simple usage like 192.168.0.101:5018, this works.
