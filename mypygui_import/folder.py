...
bt =HoverButton(BOX_2,text="\uf07c All Apps"      ,bg="#000000",activebackground="green",h_bg="red",fg="#FFFFFF",h_fg="#000000",height=0,width=0,relief="solid",command=lambda:subprocess.Popen(["explorer","shell:AppsFolder"                                                                     ],shell=True)); bt.pack(side="top",padx=(0,0),pady=(0,0))
...
bt =HoverButton(BOX_2,text="\uf07c ProgramData"   ,bg="#000000",activebackground="green",h_bg="red",fg="#FFFFFF",h_fg="#000000",height=0,width=0,relief="solid",command=lambda:subprocess.Popen(["explorer","C:\\ProgramData"                                                                      ],shell=True)); bt.pack(side="top",padx=(0,0),pady=(0,0))
...
bt =HoverButton(BOX_2,text="\uf07c Software"      ,bg="#000000",activebackground="green",h_bg="red",fg="#FFFFFF",h_fg="#000000",height=0,width=0,relief="solid",command=lambda:subprocess.Popen(["explorer","D:\\software"                                                                         ],shell=True)); bt.pack(side="top",padx=(0,0),pady=(0,0))
bt =HoverButton(BOX_2,text="\uf07c Song"          ,bg="#000000",activebackground="green",h_bg="red",fg="#FFFFFF",h_fg="#000000",height=0,width=0,relief="solid",command=lambda:subprocess.Popen(["explorer","D:\\song"                                                                             ],shell=True)); bt.pack(side="top",padx=(0,0),pady=(0,0))
bt =HoverButton(BOX_2,text="\uf07c WindowsApp"    ,bg="#000000",activebackground="green",h_bg="red",fg="#FFFFFF",h_fg="#000000",height=0,width=0,relief="solid",command=lambda:subprocess.Popen(["explorer","C:\\Program Files\\WindowsApps"                                                       ],shell=True)); bt.pack(side="top",padx=(0,0),pady=(0,0))
bt =HoverButton(BOX_2,text="\uf07c Startup-System",bg="#000000",activebackground="green",h_bg="red",fg="#FFFFFF",h_fg="#000000",height=0,width=0,relief="solid",command=lambda:subprocess.Popen(["explorer","C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Startup"                   ],shell=True)); bt.pack(side="top",padx=(0,0),pady=(0,0))
...
bt =HoverButton(BOX_2,text="\uf07c Temp-Windows"  ,bg="#000000",activebackground="green",h_bg="red",fg="#FFFFFF",h_fg="#000000",height=0,width=0,relief="solid",command=lambda:subprocess.Popen(["explorer","C:\\Windows\\Temp"                                                                    ],shell=True)); bt.pack(side="top",padx=(0,0),pady=(0,0))
