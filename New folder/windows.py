                ...
                "submenu": [
                    ...
                    },
                    {
                        ...
                        "action": {
                            "powershell": [
                                "$script = @'",
                                "Write-Host 'System Cleanup - Running as Administrator' -ForegroundColor Cyan",
                                ...
                                "            } catch { }",
                                "        }",
                                "        Write-Host \"  [SUCCESS] $Name`: Cleaned $cleaned of $totalItems items\" -ForegroundColor Green",
                                "    } catch {",
                                "        Write-Host \"  [ERROR] $Name`: Access denied or path not found\" -ForegroundColor Red",
                                "    }",
                                "}",
                                "",
                                "# Clean user temp files",
                                "Clean-Directory -Path $env:TEMP -Name 'User Temp Files'",
                                "",
                                "# Clean Windows temp files (requires admin)",
                                "Clean-Directory -Path 'C:\\Windows\\Temp' -Name 'Windows Temp Files'",
                                "",
                                "# Clean browser cache",
                                "Clean-Directory -Path \"$env:LOCALAPPDATA\\Microsoft\\Windows\\INetCache\" -Name 'Browser Cache'",
                                "",
                                "# Clean additional temp locations",
                                "Clean-Directory -Path \"$env:LOCALAPPDATA\\Temp\" -Name 'Local Temp Files'",
                                "",
                                "# Clean Windows Update cache (if accessible)",
                                "Clean-Directory -Path 'C:\\Windows\\SoftwareDistribution\\Download' -Name 'Windows Update Cache'",
                                "",
                                "Write-Host '============================================' -ForegroundColor Cyan",
                            ...
                            "description": "System Cleanup Script (runs as admin with better error handling)"
                        }
                    },
                    {
                        "title": "Check Disk", 
