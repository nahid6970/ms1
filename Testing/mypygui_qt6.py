...
class HoverLabel(QLabel):
    ...
    def __init__(self, text="", default_color="#FFFFFF", hover_color="#FF0000", 
    ...
    def mousePressEvent(self, event: QMouseEvent):
        ...
        if event.button() == Qt.MouseButton.LeftButton:
            if modifiers == Qt.KeyboardModifier.ControlModifier and self.ctrl_click_command:
                self.ctrl_click_command()
            elif self.click_command:
                self.click_command()
        elif event.button() == Qt.MouseButton.RightButton and self.right_click_command:
    ...
    def bind_ctrl_click(self, command):
        """Bind Ctrl+left click command"""
        self.ctrl_click_command = command
...
class MainWindow(QMainWindow):
    ...
    def create_left_section(self, main_layout):
        ...
        # OS Button
        os_btn = HoverLabel("OS", "#59e3a7", "#ffffff", 16)
        os_btn.bind_click(lambda: self.run_script("windows.py"))
        os_btn.bind_ctrl_click(lambda: self.edit_script("windows.py"))
