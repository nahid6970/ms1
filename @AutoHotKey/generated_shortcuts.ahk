...
;! Explorer Manager (Clean Up & Select)
;! Closes all explorers and opens a GUI to select a path to reopen
#e::Run('pythonw "C:\@delta\ms1\@AutoHotKey\explorer_manager.py"', , 'Hide')
