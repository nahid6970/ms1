...
("Install"   ,lambda: subprocess.Popen(["Start", "pwsh",  "-NoExit", "-Command", "& {$host.UI.RawUI.WindowTitle = 'Winget_fzf_install' ; Set-Location ; C:\\@delta\\ms1\\scripts\\winget_scoop\\wget_install.ps1 ; cd ~}"],shell=True)     ,"#1D2027","#00FF00",1,12,"flat",("JetBrainsMono NF",10),5,5,0,5,     6,1,1 ,""  ),
("Install2"   ,lambda: subprocess.Popen(["Start", "pwsh",  "-NoExit", "-Command", "& {$host.UI.RawUI.WindowTitle = 'Winget_fzf_install2' ; Set-Location ; C:\\@delta\\ms1\\scripts\\winget_scoop\\wget_install2.ps1 ; cd ~}"],shell=True)     ,"#1D2027","#00FF00",1,12,"flat",("JetBrainsMono NF",10),5,5,0,5,     7,1,1 ,""  ),
("Uninstall"   ,lambda: subprocess.Popen(["Start", "pwsh",  "-NoExit", "-Command", "& {$host.UI.RawUI.WindowTitle = 'Winget_fzf_Uninstall' ; Set-Location ; C:\\@delta\\ms1\\scripts\\winget_scoop\\winget_uninstall.ps1 ; cd ~}"],shell=True)     ,"#1D2027","#FF0000",1,12,"flat",("JetBrainsMono NF",10),5,5,0,5,     8,1,1 ,""  ),
...
("Install"   ,lambda: subprocess.Popen(["Start", "pwsh",  "-NoExit", "-Command", "& {$host.UI.RawUI.WindowTitle = 'scoop_fzf_install' ; Set-Location ; C:\\@delta\\ms1\\scripts\\winget_scoop\\scoop_install.ps1 ; cd ~}"],shell=True)  ,"#1D2027","#00FF00",1,12,"flat",("JetBrainsMono NF",10),5,5,0,5,     6,2,1 ,""  ),
