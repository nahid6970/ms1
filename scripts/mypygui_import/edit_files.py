...
("backup.ps1"      ,BOX_1,"#499eda","#000000",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,0),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\ms1\\scripts\\backup.ps1 }"]                                            ,shell=True)                                                                     ),
...
("update.ps1"      ,BOX_1,"#499eda","#000000",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,5),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\ms1\\scripts\\update.ps1 }"]                                            ,shell=True)                                                                     ),
