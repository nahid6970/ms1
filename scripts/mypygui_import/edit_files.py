...
("ahkscripts.ahk"  ,BOX_1,"#599b59","#ffffff",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,5),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\@delta\\ms1\\ahkscripts.ahk }"]                                        ,shell=True)                                                                     ),

("backup.ps1"      ,BOX_1,"#499eda","#000000",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,0),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\@delta\\ms1\\scripts\\backup.ps1 }"]                                            ,shell=True)                                                                     ),
("startup.ps1"     ,BOX_1,"#499eda","#000000",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,0),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\@delta\\ms1\\startup.ps1 }"]                                           ,shell=True)                                                                     ),
("update.ps1"      ,BOX_1,"#499eda","#000000",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,5),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\@delta\\ms1\\scripts\\update.ps1 }"]                                            ,shell=True)                                                                     ),
...
("yasb-config.yaml",BOX_1,"#9068b0","#ffffff",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,0),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\@delta\\ms1\\yasb\\config.yaml }"]                           ,shell=True)                                                                     ),
("yasb-styles.css" ,BOX_1,"#5995af","#ffffff",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,0),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\@delta\\ms1\\yasb\\styles.css }"]                            ,shell=True)                                                                     ),
("yasb-folder"     ,BOX_1,"#ffd359","#000000",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,0),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\@delta\\ms1\\yasb\\ }"]                                        ,shell=True)                                                                     ),
]
