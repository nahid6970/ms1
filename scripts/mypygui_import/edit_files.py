...
button_properties = [
("mypygui.py"      ,BOX_1,"#346c9a","#ffffff",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,0),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\Users\\nahid\\ms\\ms1\\mypygui.py }"]                                            ,shell=True)                                                                     ),
("desktop_icon.py" ,BOX_1,"#346c9a","#ffffff",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,5),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\Users\\nahid\\ms\\ms1\\desktop_icon.py }"]                                       ,shell=True)                                                                     ),
("edit_files.py"   ,BOX_1,"#346c9a","#ffffff",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,5),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\Users\\nahid\\ms\\ms1\\mypygui_import\\edit_files.py }"]                         ,shell=True)                                                                     ),

("ahkscripts.ahk"  ,BOX_1,"#599b59","#ffffff",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,5),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\Users\\nahid\\ms\\ms1\\ahkscripts.ahk }"]                                        ,shell=True)                                                                     ),

("backup.ps1"      ,BOX_1,"#499eda","#000000",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,0),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\Users\\nahid\\ms\\ms1\\scripts\\backup.ps1 }"]                                            ,shell=True)                                                                     ),
("startup.ps1"     ,BOX_1,"#499eda","#000000",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,0),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\Users\\nahid\\ms\\ms1\\startup.ps1 }"]                                           ,shell=True)                                                                     ),
("update.ps1"      ,BOX_1,"#499eda","#000000",1,47,"flat",("calibri",12,"bold"),0,0,(0,0),(0,5),lambda: subprocess.Popen(["Start","powershell","-Command","& { code C:\\Users\\nahid\\ms\\ms1\\scripts\\update.ps1 }"]                                            ,shell=True)                                                                     ),
