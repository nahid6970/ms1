...
class ProcessViewer(QWidget):
    ...
    def init_ui(self):
        ...
        compact_width = 600
        compact_height = 110  # Increased to accommodate bigger search box
        ...
        self.search_bar.setMinimumHeight(50)  # Make search box even taller
        self.search_bar.setStyleSheet("font-size: 18px; font-weight: bold; padding: 8px;")  # Bigger, bold font with more padding
        ...
        """)
        self.kill_button.setFixedSize(40, 40)  # Make button bigger to match search box
    ...
    def expand_window(self):
        ...
        self.animation.setDuration(150)  # Fast and snappy
    ...
    def collapse_window(self):
        ...
        screen = QApplication.primaryScreen().geometry()
        compact_width = 600
        compact_height = 110  # Match the increased compact height
