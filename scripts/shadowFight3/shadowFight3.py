        ...
        def search_and_act():
            ...
            try:
                while not state["stop_flag"]:
                    ...
                    elif find_image(Select_SelectOption, confidence=0.8, region=(1106, 632, 1509, 748)): press_keys_with_delays(window, 'h', 1) #! optional
                    ...
                    [press_keys_with_delays(window, 'c', 1)  #! creepy cont ads
                    for contimg in glob.glob(r"C:\msBackups\shadowfight3\cont_dynamic\*.png") 
                    if (location := find_image(contimg, confidence=0.8, region=contF_Region))]
                    time.sleep(0.05)
