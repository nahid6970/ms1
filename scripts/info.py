...
class ActiveWindowInfo(tk.Frame):
    ...
    def update_info(self):
        ...
        try:
            ...
            self.label_process.config(text=f"Process [ctrl+1]: {process_name}")
        ...
        self.label_class.config(text=f"Class   [ctrl+2]: {class_name}")
        self.label_title.config(text=f"Title   [ctrl+3]: {window_text}")
