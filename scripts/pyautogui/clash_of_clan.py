        ...
        def AdditionalFunction():
            ...
            try:
                while not state["stop_flag"]:
                    ...
                    # if find_image(r"C:\@delta\msBackups\CoC\builder\phase2.png", confidence=0.8, region=(1151, 816, 1273, 978)): 
                    ...
                    if find_image(r"C:\@delta\msBackups\CoC\builder\phase2.png", confidence=0.8, region=(1159, 815, 1411, 980)): 
                        press_keys_with_delays(window, 'f',4)
                    ...
                    # matches = {
                    #     "hero_1": find_image(r"C:\@delta\msBackups\CoC\builder\hero_1.png", confidence=0.80, region=(165, 815, 1660, 983)),
                    #     "pekka": find_image(r"C:\@delta\msBackups\CoC\builder\troop_pekka.png", confidence=0.80, region=(165, 815, 1660, 983)),
                    #     "bomber": find_image(r"C:\@delta\msBackups\CoC\builder\troop_bomb.png", confidence=0.80, region=(165, 815, 1660, 983)),
                    #     "cart": find_image(r"C:\@delta\msBackups\CoC\builder\troop_cart.png", confidence=0.80, region=(165, 815, 1660, 983)),
                    # }
                    # press_keys_with_delays(window, 't',4)
