...
$Package_Panel.Children.Add($close_bt)
$Package_Panel.Children.Add($maximize_bt)
$Package_Panel.Children.Add($minimize_bt)
$Package_Panel.Children.Add($BackToMain_bt)