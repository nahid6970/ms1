...
$StartStop_Upper_Panel.Children.Add($close_bt)
$StartStop_Upper_Panel.Children.Add($maximize_bt)
$StartStop_Upper_Panel.Children.Add($minimize_bt)
$StartStop_Upper_Panel.Children.Add($BackToMain_bt)