...
$Restart_Panel.Children.Add($close_bt)
$Restart_Panel.Children.Add($maximize_bt)
$Restart_Panel.Children.Add($minimize_bt)
$Restart_Panel.Children.Add($BackToMain_bt)