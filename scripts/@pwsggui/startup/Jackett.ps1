...
$Startup_Label = & $csLabel -content "Jackett"
...
$Startup_CheckBox.IsChecked = [System.IO.File]::Exists([System.IO.Path]::Combine($env:APPDATA, 'Microsoft\Windows\Start Menu\Programs\Startup', 'Jackett.lnk'))
# Add an event handler for the checkbox
$Startup_CheckBox.Add_Checked({
$shortcutPath = [System.IO.Path]::Combine($env:APPDATA, 'Microsoft\Windows\Start Menu\Programs\Startup', 'Jackett.lnk')
