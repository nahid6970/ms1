...
def Folder(WINDOWSTOOLS_FRAME):
    items = [
        ...
        ("#000000", "#ffffff", "Chris Titus Win Utility", {"command": ["powershell", "Start-Process", "-FilePath", "powershell", "-ArgumentList", 'C:/Users/nahid/ms/ms1/scripts/ctt.ps1', "-Verb", "RunAs"]}),
