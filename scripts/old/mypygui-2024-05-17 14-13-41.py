...
LB_K.bind("<Button-1>",lambda event:subprocess.Popen(["cmd /c C:\\@delta\\ms1\\scripts\\shortcut.py"], shell=True))
...
AppManagement_bt.bind("<Button-1>",lambda event:subprocess.Popen(["cmd /c start C:\\@delta\\ms1\\scripts\\mypygui_import\\app_store.py"], shell=True))
AppManagement_bt.bind("<Control-Button-1>",lambda event:subprocess.Popen(["cmd /c code C:\\@delta\\ms1\\scripts\\mypygui_import\\app_store.py"], shell=True))
AppManagement_bt.bind("<Button-3>",lambda event:subprocess.Popen(["cmd /c start C:\\@delta\\ms1\\scripts\\mypygui_import\\applist.py"], shell=True))
AppManagement_bt.bind("<Control-Button-3>",lambda event:subprocess.Popen(["cmd /c code C:\\@delta\\ms1\\scripts\\mypygui_import\\applist.py"], shell=True))
...
LB_1.bind("<Button-1>",lambda event:subprocess.Popen(["cmd /c C:\\@delta\\ms1\\scripts\\python\\bar_1.py"], shell=True))
LB_1.bind("<Control-Button-1>",lambda event:subprocess.Popen(["cmd /c code C:\\@delta\\ms1\\scripts\\python\\bar_1.py"], shell=True))
...
LB_get.bind("<Button-1>",lambda event:subprocess.Popen(["cmd /c C:\\@delta\\ms1\\scripts\\info.py"], shell=True))
LB_get.bind("<Control-Button-1>",lambda event:subprocess.Popen(["cmd /c code C:\\@delta\\ms1\\scripts\\info.py"], shell=True))
