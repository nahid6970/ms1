...
x = (screen_width - 400) // 1  # 400 is the width of your window
y = (screen_height - 770) // 2  # 700 is the height of your window

# Set the geometry of the window
ROOT.geometry(f"400x700+{x}+{y}")
...
def toggle_window_size(event):
    ...
    if window_state == 'normal':
        ...
        LB_MXM.config(text ='M',bg="Green", fg="#ffffff", height=1, width=5, highlightthickness=1, font=("agency", 10, "bold"))
        window_state = 'shrunken'
    elif window_state == 'shrunken':
        ROOT.geometry('400x700')  # Set your desired default size
        ...
        LB_MXM.config(text ='M',bg="blue", fg="#ffffff", height=1, width=5, highlightthickness=1, font=("agency", 10, "bold"))
        window_state = 'normal'
    ROOT.update_idletasks()  # Ensure the window size is updated
    ROOT.geometry(f'{ROOT.winfo_width()}x{ROOT.winfo_height()}+{ROOT.winfo_screenwidth() - ROOT.winfo_width()}+{ROOT.winfo_y()}')
...
def update_info_labels():
    ...
    if upload_speed == "0":
        LB_UPLOAD.config(bg='#000000', fg="#FFFFFF")
        ...
        LB_UPLOAD.config(bg='#00FF00', fg='#000000')  # Normal green
    else:
        LB_UPLOAD.config(bg='#006400', fg='#FFFFFF')  # Dark green
        
    # Set background color based on download speed
    if download_speed == "0":
        LB_DWLOAD.config(bg='#000000' , fg="#FFFFFF")
        ...
        LB_DWLOAD.config(bg='#00FF00', fg='#000000')  # Normal green
    else:
        LB_DWLOAD.config(bg='#006400', fg='#FFFFFF')  # Dark green
...
BOX_ROW_ROOT = tk.Frame(ROOT, bg="#1d2027", height=100) ; BOX_ROW_ROOT.pack(side="top", anchor="ne", pady=(3,0),padx=(0,3))

LB_XXX = tk.Label  (BOX_ROW_ROOT, bg="#E81123", fg="#FFFFFF", width=" 5", height="1", relief="flat", highlightthickness=1, highlightbackground="#FFFFFF", text="X", font= ("agency", 10, "bold")) ; LB_XXX.pack     (side="top", anchor="e", padx=(0,3), pady=(5,0)) ; LB_XXX.bind("<Button-1>", close_window)
LB_MXM = tk.Label  (BOX_ROW_ROOT, bg="#0000FF", fg="#FFFFFF", width=" 5", height="1", relief="flat", highlightthickness=1, highlightbackground="#FFFFFF", text="M", font= ("agency", 10, "bold")) ; LB_MXM.pack     (side="top", anchor="e", padx=(0,3), pady=(5,0)) ; LB_MXM.bind("<Button-1>", toggle_window_size)
window_state = 'normal'

LB_CPU = tk.Label  (BOX_ROW_ROOT, width=" 5", height="1", relief="flat", highlightthickness=1, highlightbackground="#76acfa", text=" ", font= ("agency", 10, "bold")) ; LB_CPU.pack     (side="top", anchor="e", padx=(0,3), pady=(5,0))
LB_RAM = tk.Label  (BOX_ROW_ROOT, width=" 5", height="1", relief="flat", highlightthickness=1, highlightbackground="#ff7500", text=" ", font= ("agency", 10, "bold")) ; LB_RAM.pack     (side="top", anchor="e", padx=(0,3), pady=(1,0))

LB_DUC = tk.Label  (BOX_ROW_ROOT, width=" 5", height="1", relief="flat", highlightthickness=1, highlightbackground="#1d2027", text=" ", font= ("agency", 10, "bold")) ; LB_DUC.pack     (side="top", anchor="e", padx=(0,3), pady=(5,0))
LB_DUD = tk.Label  (BOX_ROW_ROOT, width=" 5", height="1", relief="flat", highlightthickness=1, highlightbackground="#1d2027", text=" ", font= ("agency", 10, "bold")) ; LB_DUD.pack     (side="top", anchor="e", padx=(0,3), pady=(1,0))

LB_UPLOAD = tk.Label(BOX_ROW_ROOT, bg="#FFFF00", fg="#000000", width="5", height="1", relief="flat", highlightthickness=1, highlightbackground="#1d2027", text="▲", font=("agency", 10, "bold")) ; LB_UPLOAD.pack(side="top", anchor="ne", padx=(0,3), pady=(5,0))
LB_DWLOAD = tk.Label(BOX_ROW_ROOT, bg="#00FF00", fg="#000000", width="5", height="1", relief="flat", highlightthickness=1, highlightbackground="#1d2027", text="▼", font=("agency", 10, "bold")) ; LB_DWLOAD.pack(side="top", anchor="ne", padx=(0,3), pady=(2,0))
...
BT_CLR = tk.Button(ROOT, text="❌", command=clear_screen , fg="white" , bg="#1d2027" , relief="flat", width=3, height=1 , font=("times", 12, "bold"))
...
def open_sync(event=None):
    subprocess.Popen(["powershell", "start", "D:\@git\\ms1\\scripts\\rclone\\sync.ps1"])

def open_terminal(even=None):
    subprocess.Popen(["wt"])

BOX_ROW_MAIN = tk.Frame(MAIN_FRAME, bg="#1d2027") ; BOX_ROW_MAIN.pack(side="top", anchor="w", pady=(4,3),padx=(3,90))
LB_TERM = tk.Label (BOX_ROW_MAIN, bg="#000000", fg="#FFFFFF", height="1", width="6", relief="flat", highlightbackground="#FFFFFF", highlightthickness=1, padx=0, pady=0, font=("AGENCY", 8, "bold"), text="T") ; LB_TERM.pack(side="left", anchor='ne', padx=(0,0), pady=(1,0)) ; LB_TERM.bind("<Button-1>", open_terminal)
LB_SYNC = tk.Label (BOX_ROW_MAIN, bg="#21a366", fg="#FFFFFF", height="1", width="6", relief="flat", highlightbackground="#FFFFFF", highlightthickness=1, padx=0, pady=0, font=("AGENCY", 8, "bold"), text="S") ; LB_SYNC.pack(side="left", anchor='ne', padx=(0,0), pady=(1,0)) ; LB_SYNC.bind("<Button-1>", open_sync)
...
BOX_ROW_MAIN = tk.Frame(MAIN_FRAME, bg="#1d2027") ; BOX_ROW_MAIN.pack(side="top", anchor="w", pady=(1,3),padx=(3,90))
LB_TIME = tk.Label (BOX_ROW_MAIN, bg="#2a74de", fg="#FFFFFF", width="13", height="2", relief="flat", highlightthickness=4, highlightbackground="#FFFFFF", padx=0, pady=0, font=('terminess nerd font', 16, 'bold'), text="" ) ; LB_TIME.pack(side="left", anchor='ne', padx=(0,0), pady=(0,0))
LB_DATE = tk.Label (BOX_ROW_MAIN, bg="#2a74de", fg="#FFFFFF", width="13", height="2", relief="flat", highlightthickness=4, highlightbackground="#FFFFFF", padx=0, pady=0, font=('terminess nerd font', 16, 'bold'), text="" ) ; LB_DATE.pack(side="left", anchor='ne', padx=(0,0), pady=(0,0))
...
BOX_ROW_MAIN = tk.Frame(MAIN_FRAME, bg="black") ; BOX_ROW_MAIN.pack(pady=2) ; BOX_ROW_MAIN.pack(side="top", anchor="w", pady=(1,3),padx=(3,90))
BT_BACKUP_MAIN_FRAME = tk.Button(BOX_ROW_MAIN, bg="#21a366", fg="#ffffff", height=1, width=15, relief="flat", highlightthickness=0, padx=1, pady=0, font=("calibri", 14, "bold"), command=open_backup, text="Backup")
BT_UPDATE_MAIN_FRAME = tk.Button(BOX_ROW_MAIN, bg="#0047ab", fg="#ffffff", height=1, width=15, relief="flat", highlightthickness=0, padx=1, pady=0, font=("calibri", 14, "bold"), command=open_update, text="Update")
BT_BACKUP_MAIN_FRAME.pack(side="left", anchor="center", padx=2.5, pady=0,)
BT_UPDATE_MAIN_FRAME.pack(side="left", anchor="center", padx=2.5, pady=0,)


#! Drive size analyze using rclone
def c_size():
    subprocess.Popen(["powershell", "Start-Process rclone -ArgumentList 'ncdu c:\\' "])

def d_size():
    subprocess.Popen(["powershell", "Start-Process rclone -ArgumentList 'ncdu d:\\' "])

BOX_ROW_MAIN = tk.Frame(MAIN_FRAME, bg="black") ; BOX_ROW_MAIN.pack(pady=2) ; BOX_ROW_MAIN.pack(side="top", anchor="w", pady=(1,3),padx=(3,90))
BT_NCDU_C_MAIN_FRAME = tk.Button(BOX_ROW_MAIN, bg="#57a9f4", fg="#000000", height=1, width=15, relief="flat", highlightthickness=0, font=("calibri", 14, "bold"), command=c_size, text="C:\\ Drive", )
BT_NCDU_D_MAIN_FRAME = tk.Button(BOX_ROW_MAIN, bg="#57a9f4", fg="#000000", height=1, width=15, relief="flat", highlightthickness=0, font=("calibri", 14, "bold"), command=d_size, text="D:\\ Drive", )

BT_NCDU_C_MAIN_FRAME.pack(side="left", pady=0, padx=2.5)
BT_NCDU_D_MAIN_FRAME.pack(side="left", pady=0, padx=2.5)
...
BT_FFMPEG_MAIN_FRAME = M1_hold_release(MAIN_FRAME, "FFMPEG", switch_to_ffmpeg_frame, bg="#408b40", fg="#FFFFFF", height=1, width=30, relief="flat", highlightthickness=2, highlightbackground="#408b40", font=("Helvetica", 13, "bold")) ; BT_FFMPEG_MAIN_FRAME.pack(side="top", anchor="w", pady=(1,3),padx=(3,90))
FR_FFMPEG = tk.Frame(BORDER_FRAME, bg="#1D2327", width=400, height=700) ; FR_FFMPEG.pack_propagate(False)
...
BT_FIND_MAIN_FRAME = M1_hold_release(MAIN_FRAME, "Find", switch_to_find_frame, bg="#FFFFFF", fg="#1D2027", height=1, width=30, relief="flat", highlightthickness=2, highlightbackground="#FFFFFF", font=("Helvetica", 13, "bold")) ; BT_FIND_MAIN_FRAME.pack(side="top", anchor="w", pady=(1,3),padx=(3,90))
FR_FIND = tk.Frame(BORDER_FRAME, bg="#1D2027", width=400, height=700) ; FR_FIND.pack_propagate(False)
...
BT_PROCESS_MAIN_FRAME = M1_hold_release(MAIN_FRAME, "Process & PKG", switch_to_process_frame, bg="#cc2400", fg="#FFFFFF", height=2, width=30, relief="flat", highlightthickness=2, highlightbackground="#78ff81", font=("Helvetica", 13, "bold")) ; BT_PROCESS_MAIN_FRAME.pack(side="top", anchor="w", pady=(1,3),padx=(3,90))

FR_PROCESS = tk.Frame(BORDER_FRAME, bg="#1D2027", width=400, height=700) ; FR_PROCESS.pack_propagate(False)
...
#?            _                  _      ___     __
#?  __      _(_)_ __   __ _  ___| |_   ( _ )   / _\ ___ ___   ___  _ __
#?  \ \ /\ / / | '_ \ / _` |/ _ \ __|  / _ \/\ \ \ / __/ _ \ / _ \| '_ \
#?   \ V  V /| | | | | (_| |  __/ |_  | (_>  < _\ \ (_| (_) | (_) | |_) |
#?    \_/\_/ |_|_| |_|\__, |\___|\__|  \___/\/ \__/\___\___/ \___/| .__/
#?                    |___/                                       |_|
...
def scoop_install_fzf():
    ...
    python_script = r"C:\@delta\ms1\scripts\scoop\package_list_from_buckets.py"
    ...
    package_list_file = r"C:\@delta\ms1\scripts\scoop\package_list_bucket.txt"
...
Page1 = tk.Frame(BORDER_FRAME, bg="#1D2027", width=400, height=700)
...
BT_FOLDER_MAIN_FRAME = M1_hold_release(MAIN_FRAME, "FOLDER", switch_to_tools_frame,image=icon_image, compound=tk.TOP, bg="#e7d86a", fg="#1D2027", height=40, width=300, relief="flat", highlightthickness=2, highlightbackground="#e7d86a", font=("Helvetica", 13, "bold")) ; BT_FOLDER_MAIN_FRAME.pack(side="top", anchor="w", pady=(1,3),padx=(3,90))
FR_FOLDER = tk.Frame(BORDER_FRAME, bg="#1D2027", width=400, height=700) ; FR_FOLDER.pack_propagate(False)
...
BT_TOOLS_MAIN_FRAME = M1_hold_release(MAIN_FRAME, "TOOLS", switch_to_tools_frame, bg="#1f1f1f", fg="#FFFFFF", height=3, width=30, relief="flat", highlightthickness=2, highlightbackground="#FFFFFF", font=("Helvetica", 13, "bold")) ; BT_TOOLS_MAIN_FRAME.pack(side="top", anchor="w", pady=(1,3),padx=(3,90))
FR_TOOLS = tk.Frame(BORDER_FRAME, bg="#1D2027", width=400, height=700) ; FR_TOOLS.pack_propagate(False)
...
BOX_ROW_ONOFF = tk.Frame(MAIN_FRAME, bg="black") ; BOX_ROW_ONOFF.pack(side="top", anchor="w", pady=(1,3),padx=(3,90))
force_shutdown_bt = tk.Button(BOX_ROW_ONOFF, text="Shutdown [F]", command=force_shutdown, height=1, width=15, bg="#ff0000", fg="#ffffff", bd=0, highlightthickness=0, anchor="center", font=("calibri", 14, "bold"))
force_restart_bt  = tk.Button(BOX_ROW_ONOFF, text="Restart [F]",  command=force_restart,  height=1, width=15, bg="#ff6600", fg="#ffffff", bd=0, highlightthickness=0, anchor="center", font=("calibri", 14, "bold"))
