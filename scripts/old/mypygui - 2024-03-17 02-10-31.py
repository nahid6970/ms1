...
BOX_1_2nd,
text="Folder",
command=lambda: subprocess.Popen(["powershell", "start-process", "C:\\@delta\\ms1\\scripts\\mypygui_import\\folder.py", "-WindowStyle", "Hidden"],shell=True),
image=icon_folder,
compound=tk.LEFT,
bg="#e7d86a",
fg="#1D2027",
...
BOX_1_2nd,
text="AppList",
command=lambda: subprocess.Popen(["powershell", "start-process", "C:\\@delta\\ms1\\scripts\\mypygui_import\\applist.py"],shell=True),
image=icon_applist,
compound=tk.LEFT,
bg="#e7d86a",
fg="#1D2027",
...
BOX_1_2nd,
text="AppStore",
command=lambda: subprocess.Popen(["powershell", "start-process", "C:\\@delta\\ms1\\scripts\\mypygui_import\\app_store.py"],shell=True),
image=icon_appstore,
compound=tk.LEFT,
bg="#e7d86a",
fg="#1D2027",
...
BOX_1_2nd,
text="Process",
command=lambda: subprocess.Popen(["powershell", "start-process", "C:\\@delta\\ms1\\scripts\\mypygui_import\\process.py"],shell=True),
image=icon_process,
compound=tk.LEFT,
bg="#e7d86a",
fg="#1D2027",
...
BOX_1_2nd,
text="Tools",
command=lambda: subprocess.Popen(["powershell", "start-process", "C:\\@delta\\ms1\\scripts\\mypygui_import\\tools.py", "-WindowStyle", "Hidden"],shell=True),
image=icon_tools,
compound=tk.LEFT,
bg="#e7d86a",
fg="#1D2027",
...
BOX_1_2nd,
text="Script List",
command=lambda: subprocess.Popen(["powershell", "start-process", "C:\\@delta\\ms1\\scripts\\mypygui_import\\script_list.py", "-WindowStyle", "Hidden"],shell=True),
