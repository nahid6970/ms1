...
{"type": "Command","name": "Share Text"          ,"command": "Start-Process 'C:\\@delta\\ms1\\@Flask\\share_text\\share_text.py' -WindowStyle Hidden"},
{"type": "Command","name": "Share File"          ,"command": "Start-Process 'C:\\@delta\\ms1\\@Flask\\upload_files.py' -WindowStyle Hidden"},
{"type": "Command","name": "Share Drive"         ,"command": "Start-Process 'C:\\@delta\\ms1\\@Flask\\Browse_PC_Files\\Browse_PC_Files.py' -WindowStyle Hidden"},
...
{"type": "App","name": "AHKSCRIPT"         ,"path": "C:\\@delta\\ms1\\ahkscripts.ahk"},
