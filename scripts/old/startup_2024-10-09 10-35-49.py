...
{"type": "Command","name": "NetworkCondition"    ,"command": "Start-Process 'C:\\@delta\\ms1\\scripts\\NetworkCondition.ps1' -WindowStyle Hidden"},
...
{"type": "Command","name": "SCHEDULED"           ,"command": "Start-Process C:\\@delta\\ms1\\scripts\\scheduled.ps1"},
