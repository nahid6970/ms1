...
Import-Module -Name C:\Users\nahid\ms\ms1\scripts\@pwsggui\cls_mx_mn_bk.ps1
...
Import-Module -Name C:\Users\nahid\ms\ms1\scripts\@pwsggui\cs_mx_mm_bk\Main_Panel.ps1

$backup_bt       = req ` -content "[B]ackup"          ` -styles @($ff10, $b, $fg01, $bg02, $fz16, $w250, $h040) ` -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\Users\nahid\ms\ms1\scripts\backup.ps1`"" }
...
Import-Module -Name C:\Users\nahid\ms\ms1\scripts\@pwsggui\cs_mx_mm_bk\Tool_Panel.ps1
...
Import-Module -Name C:\Users\nahid\ms\ms1\scripts\@pwsggui\cs_mx_mm_bk\Package_Panel.ps1
...
Import-Module -Name C:\Users\nahid\ms\ms1\scripts\@pwsggui\cs_mx_mm_bk\Rclone_Panel.ps1
...
$about_bt          = req ` -content "Storage Info"     ` -styles @($ff10, $b, $fg00, $bg06, $fz16, $w250, $h040) ` -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\Users\nahid\ms\ms1\scripts\rclone\about.ps1`"" ; $Main_Panel.Content = $Rclone_Panel  }
$delete_trashgu_bt = req ` -content "Delete GU Trash"  ` -styles @($ff10, $b, $fg00, $bg06, $fz16, $w250, $h040) ` -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\Users\nahid\ms\ms1\scripts\rclone\delete_gu.ps1`"" ; $Main_Panel.Content = $Rclone_Panel  }
$touch_bt          = req ` -content "Touch Drives"     ` -styles @($ff10, $b, $fg00, $bg06, $fz16, $w250, $h040) ` -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\Users\nahid\ms\ms1\scripts\rclone\touch.ps1`"" ; $Main_Panel.Content = $Rclone_Panel  }
...
Import-Module -Name C:\Users\nahid\ms\ms1\scripts\@pwsggui\cs_mx_mm_bk\Health_Grid.ps1
...
# Define a Grid for ValoSchedule buttons
$StartStop_Panel = New-Object Windows.Controls.Grid
$StartStop_Panel.Margin = New-Object Windows.Thickness 0

# Create WrapPanel for buttons at the top
$StartStop_Upper_Panel = New-Object Windows.Controls.WrapPanel
$StartStop_Upper_Panel.Orientation = [Windows.Controls.Orientation]::vertical
$StartStop_Upper_Panel.HorizontalAlignment = [Windows.HorizontalAlignment]::Right
#$Health_UpperPart.HorizontalContentAlignment = [Windows.HorizontalAlignment]::Center
#$Health_UpperPart.VerticalAlignment = [Windows.VerticalAlignment]::Center
...
$qbittorrent_kill_bt    = req ` -content "qbit (Kill)"         ` -styles @($ff10, $b, $fg00, $bg01, $fz16, $W400, $H040, $m1) ` -onClick {  Start-Process -FilePath "taskkill" -ArgumentList "/F /IM qbittorrent.exe" -Verb RunAs ; $Main_Panel.Content = $StartStop_Panel }
$qbittorrent_restart_bt = req ` -content "qbit (Restart)"      ` -styles @($ff10, $b, $fg00, $bg01, $fz16, $W400, $H040, $m1) ` -onClick {  Start-Process "C:\Program Files\qBittorrent\qbittorrent.exe" ; $Main_Panel.Content = $StartStop_Panel }
$jackett_kill_bt        = req ` -content "Jackett (Kill)"      ` -styles @($ff10, $b, $fg00, $bg01, $fz16, $w250, $h040, $m1) ` -onClick { Start-Process -FilePath "taskkill" -ArgumentList "/F /IM JackettTray" -Verb RunAs ; $Main_Panel.Content = $StartStop_Panel }1
$jackett_restart_bt     = req ` -content "Jackett (Restart)"   ` -styles @($ff10, $b, $fg00, $bg01, $fz16, $w250, $h040, $m1) ` -onClick { Start-Process "C:\Users\nahid\scoop\apps\jackett\current\JackettTray.exe" ; $Main_Panel.Content = $StartStop_Panel }1




# Set button positions in the Grid
$StartStop_Panel.ColumnDefinitions.Add((New-Object Windows.Controls.ColumnDefinition))
$StartStop_Panel.ColumnDefinitions.Add((New-Object Windows.Controls.ColumnDefinition))

$StartStop_Panel.RowDefinitions.Add((New-Object Windows.Controls.RowDefinition)) 
$StartStop_Panel.RowDefinitions.Add((New-Object Windows.Controls.RowDefinition))
$StartStop_Panel.RowDefinitions.Add((New-Object Windows.Controls.RowDefinition))
$StartStop_Panel.RowDefinitions.Add((New-Object Windows.Controls.RowDefinition))
$StartStop_Panel.RowDefinitions.Add((New-Object Windows.Controls.RowDefinition))
...
$StartStop_Panel.RowDefinitions[0].Height = [Windows.GridLength]::Auto
$StartStop_Panel.RowDefinitions[1].Height = [Windows.GridLength]::Auto
$StartStop_Panel.RowDefinitions[2].Height = [Windows.GridLength]::Auto
$StartStop_Panel.RowDefinitions[3].Height = [Windows.GridLength]::Auto
$StartStop_Panel.RowDefinitions[4].Height = [Windows.GridLength]::Auto
$StartStop_Panel.RowDefinitions[5].Height = [Windows.GridLength]::Auto

[Windows.Controls.Grid]::SetRow($ahkscript_bt, 1)
[Windows.Controls.Grid]::SetColumn($ahkscript_bt, 0)

[Windows.Controls.Grid]::SetRow($startup_bt, 1)
[Windows.Controls.Grid]::SetColumn($startup_bt, 1)

[Windows.Controls.Grid]::SetRow($powertoys_kill_bt, 2)
[Windows.Controls.Grid]::SetColumn($powertoys_kill_bt, 0)

[Windows.Controls.Grid]::SetRow($powertoys_restart_bt, 2)
[Windows.Controls.Grid]::SetColumn($powertoys_restart_bt, 1)

[Windows.Controls.Grid]::SetRow($qbittorrent_kill_bt, 3)
[Windows.Controls.Grid]::SetColumn($qbittorrent_kill_bt, 0)

[Windows.Controls.Grid]::SetRow($qbittorrent_restart_bt, 3)
[Windows.Controls.Grid]::SetColumn($qbittorrent_restart_bt, 1)

[Windows.Controls.Grid]::SetRow($jackett_kill_bt, 4)
[Windows.Controls.Grid]::SetColumn($jackett_kill_bt, 0)

[Windows.Controls.Grid]::SetRow($jackett_restart_bt, 4)
[Windows.Controls.Grid]::SetColumn($jackett_restart_bt, 1)



# Add buttons to the Grid
$StartStop_Panel.Children.Add($ahkscript_bt)
$StartStop_Panel.Children.Add($startup_bt)
$StartStop_Panel.Children.Add($powertoys_kill_bt)
$StartStop_Panel.Children.Add($powertoys_restart_bt)
$StartStop_Panel.Children.Add($qbittorrent_kill_bt)
$StartStop_Panel.Children.Add($qbittorrent_restart_bt)
$StartStop_Panel.Children.Add($jackett_restart_bt)
$StartStop_Panel.Children.Add($jackett_kill_bt)

# Add Top, Middle, and Bottom WrapPanels to Health_Grid
[Windows.Controls.Grid]::SetRow($StartStop_Upper_Panel, 0)
[Windows.Controls.Grid]::SetColumn($StartStop_Upper_Panel, 0)
[Windows.Controls.Grid]::SetColumnSpan($StartStop_Upper_Panel, 9) # Health_UpperPart spans all 3 columns

$StartStop_Panel.Children.Add($StartStop_Upper_Panel)
...
Import-Module -Name C:\Users\nahid\ms\ms1\scripts\@pwsggui\cs_mx_mm_bk\FFmpeg_Panel.ps1

$trim_bt      =  req ` -content "Trim"            ` -styles @($ff10, $b, $fg00, $bg01, $fz16, $w250, $h040) ` -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\Users\nahid\ms\ms1\scripts\ffmpeg\trim.ps1`"" ; $Main_Panel.Content = $FFmpeg_Panel  }
$convert_bt   =  req ` -content "Convert Video"   ` -styles @($ff10, $b, $fg00, $bg01, $fz16, $w250, $h040) ` -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\Users\nahid\ms\ms1\scripts\ffmpeg\convert.ps1`"" ; $Main_Panel.Content = $FFmpeg_Panel  }
...
$merge_bt     =  req ` -content "Merge Videos"    ` -styles @($ff10, $b, $fg00, $bg01, $fz16, $w250, $h040) ` -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\Users\nahid\ms\ms1\scripts\ffmpeg\merge.ps1`"" ; $Main_Panel.Content = $FFmpeg_Panel  }
...
Import-Module -Name C:\Users\nahid\ms\ms1\scripts\@pwsggui\cs_mx_mm_bk\Find_Panel.ps1

$find_file_bt    = req ` -content "Find File"    ` -styles @($ff10, $b, $fg00, $bg01, $fz16, $w250, $h040) ` -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\Users\nahid\ms\ms1\scripts\find\find_file.ps1`"" ; $Main_Panel.Content = $Find_Panel }
$find_size_bt    = req ` -content "Find Size"    ` -styles @($ff10, $b, $fg00, $bg01, $fz16, $w250, $h040) ` -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\Users\nahid\ms\ms1\scripts\find\find_size.ps1`"" ; $Main_Panel.Content = $Find_Panel }
$find_pattern_bt = req ` -content "Find Pattern" ` -styles @($ff10, $b, $fg00, $bg01, $fz16, $w250, $h040) ` -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\Users\nahid\ms\ms1\scripts\find\find_pattern.ps1`"" ; $Main_Panel.Content = $Find_Panel }
...
Import-Module -Name C:\Users\nahid\ms\ms1\scripts\@pwsggui\cs_mx_mm_bk\Folder_Panel.ps1
...
Import-Module -Name C:\Users\nahid\ms\ms1\scripts\@pwsggui\cs_mx_mm_bk\Valorant_Panel.ps1
