...
Import-Module -Name C:\@delta\ms1\scripts\@pwsggui\cls_mx_mn_bk.ps1
...
Import-Module -Name C:\@delta\ms1\scripts\@pwsggui\cs_mx_mm_bk\Main_Panel.ps1

$backup_bt       = req ` -content "[B]ackup"          ` -styles @($ff10, $b, $fg01, $bg02, $fz16, $w250, $h040) ` -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\@delta\ms1\scripts\backup.ps1`"" }
...
$Update_bt       = req ` -content "[U]pdate"          ` -styles @($ff10, $b, $fg01, $bg03, $fz16, $w250, $h040) ` -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\@delta\ms1\scripts\update.ps1`"" }
...
Import-Module -Name C:\@delta\ms1\scripts\@pwsggui\cs_mx_mm_bk\Tool_Panel.ps1
...
Import-Module -Name C:\@delta\ms1\scripts\@pwsggui\cs_mx_mm_bk\Package_Panel.ps1
...
Import-Module -Name C:\@delta\ms1\scripts\@pwsggui\cs_mx_mm_bk\Health_Grid.ps1
...
Import-Module -Name C:\@delta\ms1\scripts\@pwsggui\cs_mx_mm_bk\FFmpeg_Panel.ps1
...
Import-Module -Name C:\@delta\ms1\scripts\@pwsggui\cs_mx_mm_bk\Find_Panel.ps1

$find_file_bt    = req ` -content "Find File"    ` -styles @($ff10, $b, $fg00, $bg01, $fz16, $w250, $h040) ` -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\@delta\ms1\scripts\find\find_file.ps1`"" ; $Main_Panel.Content = $Find_Panel }
$find_size_bt    = req ` -content "Find Size"    ` -styles @($ff10, $b, $fg00, $bg01, $fz16, $w250, $h040) ` -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\@delta\ms1\scripts\find\find_size.ps1`"" ; $Main_Panel.Content = $Find_Panel }
$find_pattern_bt = req ` -content "Find Pattern" ` -styles @($ff10, $b, $fg00, $bg01, $fz16, $w250, $h040) ` -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\@delta\ms1\scripts\find\find_pattern.ps1`"" ; $Main_Panel.Content = $Find_Panel }
...
Import-Module -Name C:\@delta\ms1\scripts\@pwsggui\cs_mx_mm_bk\Folder_Panel.ps1
