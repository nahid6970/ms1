...
("File"       ,BOX_find, lambda: open_script("C:\\@delta\\ms1\\scripts\\find\\find_file.ps1")    ,"#FFFFFF","#1D2027",1,0,"flat",("JetBrainsMono NF",11,"bold"), 1 ,1,1,1,"ew" , 0,0, (1,1),(0,0)),
("Pattern"    ,BOX_find, lambda: open_script("C:\\@delta\\ms1\\scripts\\find\\find_pattern.ps1") ,"#FFFFFF","#1D2027",1,0,"flat",("JetBrainsMono NF",11,"bold"), 1 ,2,1,1,"ew" , 0,0, (1,1),(0,0)),
("Size"       ,BOX_find, lambda: open_script("C:\\@delta\\ms1\\scripts\\find\\find_size.ps1")    ,"#FFFFFF","#1D2027",1,0,"flat",("JetBrainsMono NF",11,"bold"), 1 ,3,1,1,"ew" , 0,0, (1,1),(0,0)),
