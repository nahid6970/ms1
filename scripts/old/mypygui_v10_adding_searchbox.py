...
def git_sync(event=None):
    subprocess.Popen(["powershell", "C:\\@delta\\ms1\\scripts\\Github\\ms1u.ps1 ; C:\\@delta\\ms1\\scripts\\Github\\ms2u.ps1"])
...
def extra_bar(event=None):
    subprocess.Popen(["powershell", "start-process", "C:\\@delta\\ms1\\scripts\\python\\bar_1.py", "-WindowStyle", "Hidden"])
...
def rclone_sync(event=None):
    subprocess.Popen(["powershell", "start", "C:\\@delta\\ms1\\scripts\\sync.ps1"])
...
def find_file():
    subprocess.run(["powershell", "start", "C:\\@delta\\ms1\\scripts\\find\\find_file.ps1"])

def find_patt():
    subprocess.run(["powershell", "start", "C:\\@delta\\ms1\\scripts\\find\\find_pattern.ps1"])

def find_size():
    subprocess.run(["powershell", "start", "C:\\@delta\\ms1\\scripts\\find\\find_size.ps1"])
...
applications = [
    ...
    {"name": "ReIcon"           , "scoop_name": "ReIcon"                            , "scoop_path": r'C:\Users\nahid\scoop\apps\reicon\current\ReIcon.exe'                                , "winget_name": ""                                , "winget_path": ""                                                               , "chkbx_var": chkbx_ReIcon}                           ,
    ...
    {"name": "winget"           , "scoop_name": "winget"                            , "scoop_path": r'C:\Users\nahid\scoop\apps\winget\current\winget.exe'                                , "winget_name": ""                                , "winget_path": ""                                                               , "chkbx_var": chkbx_winget}                           ,
    ...
    {"name": "WinaeroTweaker"   , "scoop_name": "winaero-tweaker"                   , "scoop_path": r'C:\Users\nahid\scoop\apps\winaero-tweaker\current\WinaeroTweaker.exe'               , "winget_name": ""                                , "winget_path": ""                                                               , "chkbx_var": chkbx_winaero_tweaker}                  ,
    ...
    {"name": "scoop-completion" , "scoop_name": "scoop-completion"                  , "scoop_path": r'C:\Users\nahid\scoop\apps\scoop-completion\current\scoop-completion.psm1'           , "winget_name": ""                                , "winget_path": ""                                                               , "chkbx_var": chkbx_scoop_completion}                 ,
    {"name": "scoop-search"     , "scoop_name": "scoop-search"                      , "scoop_path": r'C:\Users\nahid\scoop\apps\scoop-search\current\scoop-search.exe'                    , "winget_name": ""                                , "winget_path": ""                                                               , "chkbx_var": chkbx_scoop_search}                     ,
...
def font_style():
    subprocess.Popen(["powershell", "start", "C:\\@delta\\ms1\\scripts\\python\\font_style.py"],  shell=True)
def Keybinding():
    subprocess.Popen(["powershell", "start", "C:\\@delta\\ms1\\scripts\\python\\Keybinding.py"],  shell=True)
def dictionary():
    subprocess.Popen(["powershell", "start", "C:\\@delta\\ms1\\scripts\\python\\dictionary.py"],  shell=True)
def regedit_run(event=None):
    subprocess.Popen(["powershell", "-Command", "Start-Process", "-FilePath", "python", "-ArgumentList", "C:\\@delta\\ms1\\scripts\\python\\regedit.py", "-Verb", "RunAs"], shell=True)
