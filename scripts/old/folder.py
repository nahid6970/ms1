...
bt =HoverButton(BOX_2,text="\uf07c .yasb"         ,bg="#000000",activebackground="green",h_bg="red",fg="#FFFFFF",h_fg="#000000",height=0,width=0,relief="solid",command=lambda:(subprocess.Popen(["explorer","C:\\@delta\\ms1\\yasb"],shell=True),close_window()));                                                                         bt.pack(side="top", anchor="w",padx=(0,0),pady=(0,0))
