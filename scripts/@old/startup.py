...
{"type": "Command","name": "Flask - 5001 - Text"              ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\@delta\\ms1\\@Flask\\5001_share_text\\share_text.py"},
{"type": "Command","name": "Flask - 5002 - Share File"        ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\@delta\\ms1\\@Flask\\5002_upload_files\\upload_files.py"},
{"type": "Command","name": "Flask - 5003 - Drive"             ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\@delta\\ms1\\@Flask\\5003_Browse_PC_Files\\Browse_PC_Files.py"},
{"type": "Command","name": "Flask - 5005 - GameARR"           ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\@delta\\ms1\\@Flask\\5005_GameARR\\GameARR.py"},
{"type": "Command","name": "Flask - 5006 - Run Commands"      ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\@delta\\ms1\\@Flask\\5006_Run_Commands\\Run_Commands.py"},
{"type": "Command","name": "Flask - 5007 - ControlBy Android" ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\@delta\\ms1\\@Flask\\5007_Controlby_Android\\Android_Control_PC.py"},
{"type": "Command","name": "Flask - 5008 - Valorant Match"    ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\@delta\\ms1\\@Flask\\5008_esports_scheduler\\Esports_Match_Schedule.py"},
{"type": "Command","name": "Flask - 5009 - MCQ"               ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\@delta\\ms1\\@Flask\\5009_MCQ\\app.py"},
{"type": "Command","name": "Flask - 5010 - CoC"               ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\@delta\\ms1\\@Flask\\5010_coc\\Clash_of_Clans.py"},
{"type": "Command","name": "Clipboard"                        ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\@delta\\ms1\\scripts\\clipboard.py"},
{"type": "Command","name": "Komorebi"                         ,"paths": [r"C:\@delta\ms1\scripts\Autohtokey\Command\komorebi.ahk"]},
{"type": "Command","name": "mypygui"                          ,"paths": [r"C:\@delta\ms1\scripts\Autohtokey\Command\mypygui.ahk"]},
{"type": "Command","name": "Open WebUI"                       ,"paths": [r"C:\@delta\ms1\scripts\Autohtokey\Command\openwebui.ahk"]},
{"type": "Command","name": "Remote Control"                   ,"paths": [r"C:\@delta\ms1\scripts\Autohtokey\Command\remote_control.ahk"]},
{"type": "Command","name": "Square-Corner"                    ,"paths": [r"C:\@delta\ms1\scripts\Autohtokey\Command\square_corner.ahk"]},
{"type": "Command","name": "SSHD"                             ,"paths": [r"C:\@delta\ms1\scripts\Autohtokey\Command\sshd.ahk"]},
{"type": "Command","name": "Sync"                             ,"paths": [r"C:\\@delta\\ms1\\scripts\\sync.ps1"]},
{"type": "Command","name": "Syncthing"                        ,"paths": [r"C:\@delta\ms1\scripts\Autohtokey\Command\syncthing.ahk"]},
{"type": "Command","name": "Virtual_Monitor"                  ,"paths": [r"C:\@delta\ms1\scripts\Autohtokey\Command\virtual_monitor.ahk"]},
{"type": "Command","name": "Disable Defender"                 ,"paths": [r"C:\@delta\ms1\scripts\disable_defender.ps1"]},

# {"type": "Command","name": "arr_monitor"      ,"paths": "Start-Process 'C:/@delta/ms1/scripts/arr/arr_monitor.ps1' -WindowStyle Hidden"},
# {"type": "Command","name": "NetworkCondition" ,"paths": "Start-Process 'C:\\@delta\\ms1\\scripts\\NetworkCondition.ps1' -WindowStyle Hidden"},
# {"type": "Command","name": "Scheduled_Task"   ,"paths": "C:\\@delta\\ms1\\scripts\\scheduled.ps1"},

# {"type": "Command","name": "ahk_v1"           ,"paths": r"C:\@delta\ms1\scripts\@old\ahk_v1.ahk"},
# {"type": "Command","name": "MONITOR_SIZE"     ,"paths": "Start-Process 'powershell.exe' -ArgumentList '-File C:\\@delta\\ms1\\scripts\\monitor_size.ps1' -Verb RunAs -WindowStyle Hidden"},
