...
#    rclone sync "C:\@delta\ms1\"   "o0:\Git\ms1\" -P --check-first --transfers=1 --track-renames --fast-list --stats-one-line      --exclude .git/  # --log-level INFO  --log-file="D:\OneDrive\x.log"
