...
myGui.Add("Text", "x+5 yp Background31ffc1 c000000 w50 +Center +Border", "").OnEvent("Click", (*) => (Run("C:\@delta\ms1\scripts\xy\XY_CroosHair.py",, "Hide"))) ;; CrossHair
myGui.Add("Text", "x+5 yp Background31ffc1 cec2d47 w50 +Center +Border", "").OnEvent("Click", (*) => (Run("C:\@delta\ms1\scripts\Locker.py",, "Hide"))) ;; Locker ;; python script

myGui.SetFont("s20 Bold", "Jetbrainsmono nfp")
myGui.Add("Text", "xm y+5 Background31ffc1 c000000 w50 +Center +Border", "").OnEvent("Click", (*) => (Run("C:\@delta\ms1\scripts\ffmpeg\trim.ps1",, "Show"))) ;; ffmpeg video cut
...
myGui.Add("Text", "x+5 yp Background32ec44 cBlack w200 +Center", "AhkConverter").OnEvent("Click", (*) => (myGui.Destroy(),Run("C:\Users\nahid\ms\msBackups\Autohotkey\AHK_converter\QuickConvertorV2_scintilla.ahk", , "Hide")))
myGui.Add("Text", "x+5 yp Background32ec44 cBlack w200 +Center", "UIA-V2").OnEvent("Click", (*) => (myGui.Destroy(),Run("C:\@delta\ms1\scripts\Autohtokey\UIA_v2\Lib\UIA.ahk", , "Hide")))
