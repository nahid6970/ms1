...
myGui.Add("Text", "x+5 yp Background32ec44 cBlack w200 +Center", "AhkConverter").OnEvent("Click", (*) => (myGui.Destroy(),Run("C:\@delta\msBackups\Autohotkey\AHK_converter\QuickConvertorV2_scintilla.ahk", , "Hide")))
