Import-Module -Name C:\ms1\scripts\@pwsggui\cs.ps1
...
$backup_bt = & $bkup -content "Backup 🔃" -onClick { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\ms1\scripts\backup.ps1`"" }
$Update_bt = & $updt -content "Update 👍🏻" -onClick({ Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\ms1\scripts\update.ps1`"" })
...
$sync_bt = & $cs2 -content "Sync" -onClick {  Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\ms1\scripts\rclone\sync.ps1`"" ; $Main_Panel.Content = $Rclone_Panel  }
$about_bt = & $cs2 -content "Storage Info" -onClick {  Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\ms1\scripts\rclone\about.ps1`"" ; $Main_Panel.Content = $Rclone_Panel  }
$delete_trashgu_bt = & $cs2 -content "Delete GU Trash" -onClick {  Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\ms1\scripts\rclone\delete_gu.ps1`"" ; $Main_Panel.Content = $Rclone_Panel  }
$touch_bt = & $cs2 -content "Touch Drives" -onClick {  Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\ms1\scripts\rclone\touch.ps1`"" ; $Main_Panel.Content = $Rclone_Panel  }
...
$trim_bt = & $cs2 -content "Trim" -onClick {  Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\ms1\scripts\ffmpeg\trim.ps1`"" ; $Main_Panel.Content = $FFmpeg_Panel  }
$convert_bt = & $cs2 -content "Convert Video" -onClick {  Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\ms1\scripts\ffmpeg\convert.ps1`"" ; $Main_Panel.Content = $FFmpeg_Panel  }
$dimension_bt = & $cs2 -content "Video Dimension" -onClick {  Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\ms1\scripts\ffmpeg\dimension.ps1`"" ; $Main_Panel.Content = $FFmpeg_Panel  }
$imgdim_bt = & $cs2 -content "Image Dimension" -onClick {  Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\ms1\scripts\ffmpeg\imgdim.ps1`"" ; $Main_Panel.Content = $FFmpeg_Panel  }
$merge_bt = & $cs2 -content "Merge Videos" -onClick {  Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\ms1\scripts\ffmpeg\merge.ps1`"" ; $Main_Panel.Content = $FFmpeg_Panel  }
...
$find_file_bt = & $cs2 -content "Find File" -onClick  { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\ms1\scripts\find\find_file.ps1`"" ; $Main_Panel.Content = $Find_Panel }
$find_size_bt = & $cs2 -content "Find Size" -onClick  { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\ms1\scripts\find\find_size.ps1`"" ; $Main_Panel.Content = $Find_Panel }
$find_pattern_bt = & $cs2 -content "Find Pattern" -onClick  { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\ms1\scripts\find\find_pattern.ps1`"" ; $Main_Panel.Content = $Find_Panel }
...
$valo_ahk_bt = & $vlr -content "Valorant-AHK" -onClick { C:\ms1\scripts\valorant\valo.ahk; $Main_Panel.Content = $Valorant_Panel}
$valorant_qbit_bt = & $vlr -content "Valorant + Qbit" -onClick  { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\ms1\scripts\valorant\valo_qbit.ps1`"" ; $Main_Panel.Content = $Valorant_Panel }
