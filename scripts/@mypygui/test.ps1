...
$find_file_bt = & $cs2 -content "Find File" -onClick  { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\@delta\ms1\scripts\find\find_file.ps1`"" ; $Main_Panel.Content = $Find_Panel }
$find_size_bt = & $cs2 -content "Find Size" -onClick  { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\@delta\ms1\scripts\find\find_size.ps1`"" ; $Main_Panel.Content = $Find_Panel }
$find_pattern_bt = & $cs2 -content "Find Pattern" -onClick  { Start-Process -FilePath "pwsh" -ArgumentList "-NoExit -File `"C:\@delta\ms1\scripts\find\find_pattern.ps1`"" ; $Main_Panel.Content = $Find_Panel }
