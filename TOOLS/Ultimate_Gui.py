...
def create_control_panel_without_tab_border():
    ...
    crosshair_button.bind("<Button-1>", lambda event: run_script("C:\\@delta\\ms1\\scripts\\xy\\XY_CroosHair.py", hide=True))
    ...
    locker_button.bind("<Button-1>", lambda event: run_script("C:\\@delta\\ms1\\scripts\\Locker.py", hide=True))
    ...
    ahk_converter_button.bind("<Button-1>", lambda event: (root.destroy(), run_script("C:\\@delta\\msBackups\\Autohotkey\\AHK_converter\\QuickConvertorV2_scintilla.ahk", hide=True)))
    ...
    uia_v2_button.bind("<Button-1>", lambda event: (root.destroy(), run_script("C:\\@delta\\ms1\\scripts\\Autohtokey\\UIA_v2\\Lib\\UIA.ahk", hide=True)))
    ...
    ffmpeg_trim_button.bind("<Button-1>", lambda event: run_script("C:\\@delta\\ms1\\scripts\\ffmpeg\\trim.ps1", hide=False))
    ...
    ffmpeg_convert_button.bind("<Button-1>", lambda event: run_script("C:\\@delta\\ms1\\scripts\\ffmpeg\\convert.ps1", hide=False))
    ...
    ffmpeg_merge_button.bind("<Button-1>", lambda event: run_script("C:\\@delta\\ms1\\scripts\\ffmpeg\\merge.ps1", hide=False))
    ...
    ffmpeg_vid_dim_button.bind("<Button-1>", lambda event: run_script("C:\\@delta\\ms1\\scripts\\ffmpeg\\vid_dim.ps1", hide=False))
