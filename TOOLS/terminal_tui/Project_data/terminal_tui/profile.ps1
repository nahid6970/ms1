# Custom PowerShell Profile for project: terminal_tui
...
if (Get-Command Set-PSReadLineOption -ErrorAction SilentlyContinue) {
    Set-PSReadLineOption -HistorySavePath "C:/@delta/ms1/TOOLS/terminal_tui/Project_data/terminal_tui/history.txt"
}
