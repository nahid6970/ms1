...
function ahkscripts            { Start-Process "C:\git\ms1\ahkscripts.ahk" }
...
function monitor_size          { Start-Process "powershell.exe" -ArgumentList "-File C:\git\ms1\scripts\monitor_size.ps1" -Verb RunAs -WindowStyle Hidden }
...
function radarr_monitor        { Start-Process "C:\git\ms1\scripts\arr\radarr.ps1" -WindowStyle Hidden }
...
function sonarr_monitor        { Start-Process "C:\git\ms1\scripts\arr\sonarr.ps1" -WindowStyle Hidden }
function sync                  { Start-Process "C:\git\ms1\sync.ps1" }
function syncthing             { Start-Process "C:\Users\nahid\scoop\apps\syncthing\current\syncthing.exe" -WindowStyle Hidden }
function valo_qbit             { Start-Process "C:\git\ms1\scripts\valorant\valo_qbit.ps1" -WindowStyle Hidden }
