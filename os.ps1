    ...
    "[+] mklink" = [ordered]@{
        ...
        "Prowlarr" = {
            nw_pwsh_asadmin -Command {
                ...
                # New-Item -ItemType SymbolicLink -Path C:\ProgramData\Prowlarr\prowlarr.db -Target C:\@delta\msBackups\@mklink\prowlarr\prowlarr.db -Force -Verbose
        ...
        "Radarr" = {
            nw_pwsh_asadmin -Command {
                ...
                # New-Item -ItemType SymbolicLink -Path C:\ProgramData\Radarr\radarr.db -Target C:\@delta\msBackups\@mklink\radarr\radarr.db -Force -Verbose
        ...
        "Sonarr" = {
            nw_pwsh_asadmin -Command {
                ...
                # New-Item -ItemType SymbolicLink -Path C:\ProgramData\Sonarr\sonarr.db -Target C:\@delta\msBackups\@mklink\sonarr\sonarr.db -Force -Verbose
