...
- **Console Terminal Toggle**: Show/hide the original Python console window with real-time output
...
- **🖥️**: Toggle console terminal (shows/hides the original Python console window)
