...
OS_LB.bind("<Button-1>",lambda event=None:subprocess.Popen('cmd /c C:\\@delta\\ms1\\os.ps1'))
OS_LB.bind("<Control-Button-1>",lambda event=None:subprocess.Popen('cmd /c code C:\\@delta\\ms1\\os.ps1'))
...
Rclone_bt.bind("<Button-1>",lambda event:subprocess.Popen(["cmd /c start C:\\@delta\\ms1\\scripts\\rclone\\RCLONE-MANAGER\\Rclone-Manager.py"], shell=True))
Rclone_bt.bind("<Control-Button-1>",lambda event:subprocess.Popen(["cmd /c code C:\\@delta\\ms1\\scripts\\rclone\\RCLONE-MANAGER\\Rclone-Manager.py"], shell=True))
