...
{"type": "Command","name": "ollama-chat"                      ,"paths": [r"C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe"] , "Command": r"C:\ms1\ollama-chat-app\server.py"},
{"type": "Command","name": "Flask - 5001 - Text"              ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\ms1\\scripts\\flask\\5001_share_text\\share_text.py"},
{"type": "Command","name": "Flask - 5002 - Share File"        ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\ms1\\scripts\\flask\\5002_upload_files\\upload_files.py"},
{"type": "Command","name": "Flask - 5003 - Drive"             ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\ms1\\scripts\\flask\\5003_Browse_PC_Files\\Browse_PC_Files.py"},
{"type": "Command","name": "Flask - 5005 - GameARR"           ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\ms1\\scripts\\flask\\5005_GameARR\\GameARR.py"},
{"type": "Command","name": "Flask - 5006 - Run Commands"      ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\ms1\\scripts\\flask\\5006_Run_Commands\\Run_Commands.py"},
{"type": "Command","name": "Flask - 5007 - ControlBy Android" ,"paths": [r"C:\Users\nahid\scoop\apps\python312\current\pythonw.exe"] , "Command": "C:\\ms1\\scripts\\flask\\5007_Controlby_Android\\Android_Control_PC.py"},
...
{"type": "Command","name": "Remote Control"                   ,"paths": [r"C:\ms1\scripts\Autohtokey\Command\remote_control.ahk"]},
{"type": "Command","name": "Square-Corner"                    ,"paths": [r"C:\ms1\scripts\Autohtokey\Command\square_corner.ahk"]},
{"type": "Command","name": "SSHD"                             ,"paths": [r"C:\ms1\scripts\Autohtokey\Command\sshd.ahk"]},
{"type": "Command","name": "Sync"                             ,"paths": [r"C:\\ms1\\scripts\\sync.ps1"]},
{"type": "Command","name": "Syncthing"                        ,"paths": [r"C:\ms1\scripts\Autohtokey\Command\syncthing.ahk"]},
{"type": "Command","name": "Virtual_Monitor"                  ,"paths": [r"C:\ms1\scripts\Autohtokey\Command\virtual_monitor.ahk"]},
{"type": "Command","name": "Disable Defender"                 ,"paths": [r"C:\ms1\scripts\disable_defender.ps1"]},

# {"type": "Command","name": "arr_monitor"      ,"paths": "Start-Process 'C:/ms1/scripts/arr/arr_monitor.ps1' -WindowStyle Hidden"},
