...
OS_LB.bind("<Button-1>",lambda event=None:subprocess.Popen('cmd /c C:\\Users\\nahid\\ms\\ms1\\os.ps1'))
OS_LB.bind("<Control-Button-1>",lambda event=None:subprocess.Popen('cmd /c code C:\\Users\\nahid\\ms\\ms1\\os.ps1'))
...
AppManagement_bt.bind("<Button-1>",lambda event:subprocess.Popen(["cmd /c start C:\\Users\\nahid\\ms\\ms1\\scripts\\mypygui_import\\app_store.py"], shell=True))
AppManagement_bt.bind("<Control-Button-1>",lambda event:subprocess.Popen(["cmd /c code C:\\Users\\nahid\\ms\\ms1\\scripts\\mypygui_import\\app_store.py"], shell=True))
...
ShadowFight3_lb.bind( "<Button-3>", lambda event=None: run_command(r'python C:\Users\nahid\ms\ms1\scripts\CoC\CoC.py'))
ShadowFight3_lb.bind("<Control-Button-3>",lambda event=None: run_command('code C:\\Users\\nahid\\ms\\ms1\\scripts\\CoC\\CoC.py'))
