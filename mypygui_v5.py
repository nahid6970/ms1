...
def update_info_labels():
    ...
    if upload_speed == "0":
        ...
        LB_UPLOAD.config(bg='#D9F3D9', fg="#000000")
    ...
    if download_speed == "0":
        ...
        LB_DWLOAD.config(bg='#D9F3D9', fg="#000000")
...
LB_M = tk.Label(BOX_ROW_ROOT, bg="#0000FF", fg="#FFFFFF", width=" 2", height="1", relief="flat", highlightthickness=1, highlightbackground="#FFFFFF", padx=1, pady=0, text="M", font=("AGENCY", 10, "bold")) ; LB_M.pack(side="right", anchor="e", padx=(0,3), pady=(0,0)) ; LB_M.bind("<Button-1>", lambda event: toggle_window_size('M'))
LB_L = tk.Label(BOX_ROW_ROOT, bg="#0000FF", fg="#FFFFFF", width=" 2", height="1", relief="flat", highlightthickness=1, highlightbackground="#FFFFFF", padx=1, pady=0, text="L", font=("AGENCY", 10, "bold")) ; LB_L.pack(side="right", anchor="e", padx=(0,3), pady=(0,0)) ; LB_L.bind("<Button-1>", lambda event: toggle_window_size('L'))
LB_S = tk.Label(BOX_ROW_ROOT, bg="#0000FF", fg="#FFFFFF", width=" 2", height="1", relief="flat", highlightthickness=1, highlightbackground="#FFFFFF", padx=1, pady=0, text="S", font=("AGENCY", 10, "bold")) ; LB_S.pack(side="right", anchor="e", padx=(0,3), pady=(0,0)) ; LB_S.bind("<Button-1>", lambda event: toggle_window_size('S'))
...
LB_DUD = tk.Label  (BOX_ROW_ROOT, width=" 6", height="1", relief="flat", highlightthickness=1, highlightbackground="#FFFFFF", padx=1, pady=0, text=" ", font= ("agency", 10, "bold")) ; LB_DUD.pack     (side="right", anchor="e", padx=(0,3), pady=(0,0))
LB_DUC = tk.Label  (BOX_ROW_ROOT, width=" 6", height="1", relief="flat", highlightthickness=1, highlightbackground="#FFFFFF", padx=1, pady=0, text=" ", font= ("agency", 10, "bold")) ; LB_DUC.pack     (side="right", anchor="e", padx=(0,3), pady=(0,0))
LB_RAM = tk.Label  (BOX_ROW_ROOT, width=" 6", height="1", relief="flat", highlightthickness=1, highlightbackground="#ff7500", padx=1, pady=0, text=" ", font= ("agency", 10, "bold")) ; LB_RAM.pack     (side="right", anchor="e", padx=(0,3), pady=(0,0))
LB_CPU = tk.Label  (BOX_ROW_ROOT, width=" 5", height="1", relief="flat", highlightthickness=1, highlightbackground="#76acfa", padx=1, pady=0, text=" ", font= ("agency", 10, "bold")) ; LB_CPU.pack     (side="right", anchor="e", padx=(0,3), pady=(0,0))

STATUS_MS1 = tk.Label(BOX_ROW_ROOT, bg="#000000", width=" 2", height="1", relief="flat", highlightthickness=1, highlightbackground="#76acfa", padx=1, pady=0, text="⚠️", font= ("agency", 10, "bold")) ; STATUS_MS1.bind("<Button-1>", lambda event: show_git_changes("C:\git\\ms1")) ; STATUS_MS1.pack(side="left", anchor="e", padx=(0,3), pady=(0,0))
STATUS_MS2 = tk.Label(BOX_ROW_ROOT, bg="#000000", width=" 2", height="1", relief="flat", highlightthickness=1, highlightbackground="#76acfa", padx=1, pady=0, text="⚠️", font= ("agency", 10, "bold")) ; STATUS_MS2.bind("<Button-1>", lambda event: show_git_changes("C:\git\\ms2")) ; STATUS_MS2.pack(side="left", anchor="e", padx=(0,3), pady=(0,0))
...
LB_RULERSR = tk.Label (BOX_ROW2_ROOT, bg="#ff6600", fg="#000000", height="1", width="3", relief="flat", highlightthickness=1, highlightbackground="#FFFFFF", padx=1, pady=0, font=("AGENCY", 10, "bold"), text="R") ; LB_RULERSR.pack(side="left", anchor='e', padx=(0,3), pady=(0,0)) ; LB_RULERSR.bind("<Button-1>", shortcut_scaleruler)
...
LB_TIME = tk.Label (BOX_ROW_MAIN, bg="#1d2027", fg="#FFFFFF", width="13", height="2", relief="flat", highlightthickness=4, highlightbackground="#1d2027", padx=0, pady=0, font=('terminess nerd font', 16, 'bold'), text="" ) ; LB_TIME.pack(side="left", anchor='ne', padx=(0,0), pady=(0,0))
LB_DATE = tk.Label (BOX_ROW_MAIN, bg="#1d2027", fg="#FFFFFF", width="13", height="2", relief="flat", highlightthickness=4, highlightbackground="#1d2027", padx=0, pady=0, font=('terminess nerd font', 16, 'bold'), text="" ) ; LB_DATE.pack(side="left", anchor='ne', padx=(0,0), pady=(0,0))
...
BT_BACK = tk.Button(FR_FFMPEG, text="◀", command=lambda: switch_to_frame(MAIN_FRAME, FR_FFMPEG), bg="#4b6a86", fg="#000", relief="flat", height=25, padx=0, width=1, font=("calibri", 10, "bold")) ; BT_BACK.pack(side="right", anchor="w", padx=(0,5), pady=(0,0))
...
BT_BACK = tk.Button(FR_FIND, text="◀", command=lambda: switch_to_frame(MAIN_FRAME, FR_FIND), bg="#4b6a86", fg="#000", relief="flat", height=25, padx=0, width=1, font=("calibri", 10, "bold")) ; BT_BACK.pack(side="right", anchor="w", padx=(0,5), pady=(0,0))
...
BT_BACK = tk.Button(FR_FOLDER, text="◀", command=lambda: switch_to_frame(MAIN_FRAME, FR_FOLDER), bg="#4b6a86", fg="#000", relief="flat", height=25, padx=0, width=1, font=("calibri", 10, "bold")) ; BT_BACK.pack(side="right", anchor="w", padx=(0,5), pady=(0,0))
...
BT_BACK = tk.Button(FR_PROCESS, text="◀", command=lambda: switch_to_frame(MAIN_FRAME, FR_PROCESS), bg="#4b6a86", fg="#000", relief="flat", height=25, padx=0, width=1, font=("calibri", 10, "bold")) ; BT_BACK.pack(side="right", anchor="w", padx=(0,5), pady=(0,0))
...
BT_BACK = tk.Button(Page1, text="◀", command=lambda: switch_to_frame(FR_PROCESS, Page1 ), bg="#4b6a86", fg="#000", relief="flat", height=25, padx=0, width=1, font=("calibri", 10, "bold")) ; BT_BACK.pack(side="right", anchor="w", padx=(0,5), pady=(0,0))
...
BT_BACK = tk.Button(FR_TOOLS, text="◀", command=lambda: switch_to_frame(MAIN_FRAME, FR_TOOLS), bg="#4b6a86", fg="#000", relief="flat", height=25, padx=0, width=1, font=("calibri", 10, "bold")) ; BT_BACK.pack(side="right", anchor="w", padx=(0,5), pady=(0,0))
