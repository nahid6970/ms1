...
class ProfileDialog(QDialog):
    ...
    def init_ui(self):
        ...
        layout.addWidget(QLabel("Target Path (Where to copy)"))
        target_layout = QHBoxLayout()
        self.target_input = QLineEdit(self.profile.get("target_path", TARGET_DIR))
    ...
    def browse_target(self):
        path = QFileDialog.getExistingDirectory(self, "Select Target Directory", self.target_input.text())
        if path:
    ...
    def save(self):
        ...
        self.profile["target_path"] = self.target_input.text()
...
class VSCodeStateManager(QMainWindow):
    ...
    def execute_activation(self, profile):
        ...
        target_dir = profile.get("target_path", TARGET_DIR)
