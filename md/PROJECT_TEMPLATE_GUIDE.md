...
When giving AI context, reference only the last few sessions to avoid overloading context.
...
2. **When giving AI context from RECENT.md**, only reference the last few sessions to keep context lean
