...
chrome_label.grid (row=0,column=2,padx=5,pady=(3,1))
Code_label.grid   (row=0,column=3,padx=5,pady=(3,1))
Python_label.grid (row=0,column=4,padx=5,pady=(3,1))
