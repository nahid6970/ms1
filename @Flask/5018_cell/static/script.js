    ...
    sheet.columns.forEach((col, index) => {
        ...
        if (index === 0) {
            ...
            toggleSpan.innerHTML =
                ...
                `<button onclick="(function(){const i=tableData.sheets.findIndex(s=>String(s.customIndex)==='20260520102127');if(i>=0)switchSheet(i);else showToast('Sheet not found','warning');})()" title="Go to Syllabus" class="btn-header-toggle"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="2" y="2" width="9" height="12" rx="1"/><path d="M5 2v12"/><path d="M11 4h2a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1h-2"/></svg></button>` +
                `</span>`;
