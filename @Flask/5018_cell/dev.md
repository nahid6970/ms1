...
- **Append new sessions to the top** (most recent first)
- **Never delete old sessions** - maintain complete development history
...
- **[Recent Work Log](md/RECENT.md):** All development sessions and current project state.
