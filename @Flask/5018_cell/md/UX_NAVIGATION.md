...
- **Search Bar**: A built-in search input at the top of the dropdown allows for real-time filtering of sub-sheets. It automatically receives focus when the menu is opened.
