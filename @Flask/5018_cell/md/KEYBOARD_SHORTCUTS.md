...
| **F10** | Mark hovered word span for F3 formatting without entering edit mode |
...
- **F10** - Hover-select one word, then another word in the same cell to mark the full span for F3
