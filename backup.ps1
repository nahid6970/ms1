...
#Installed-Apps-Backup
    # moved to update.ps1 scoop export > C:\git\ms1\asset\installedApps\list_scoop.txt
    # moved to update.ps1 winget export C:\git\ms1\asset\installedApps\list_winget.txt > C:\git\ms1\asset\installedApps\ex_wingetlist.txt
   # Start-Process -FilePath "winget" -ArgumentList "export C:\git\ms1\asset\installedApps\winget_apps.txt" -RedirectStandardOutput "C:\git\ms1\asset\installedApps\winget_unknown.txt" -WindowStyle Hidden #-Wait -NoNewWindow
    #winget list > C:\git\ms1\asset\installedApps\winget_list.txt
    #C:\git\ms1\scripts\scoop\scoop_list.ps1
    #Start-Process -FilePath "winget" -ArgumentList "export C:\git\ms1\asset\installedApps\winget_apps.txt" -RedirectStandardOutput "C:\git\ms1\asset\installedApps\winget_unknown.txt" #-Wait -NoNewWindow  
...
#OrgDoc Convert to html
    pandoc -s C:\git\ms2\Files\MyOrg.org  -o C:\git\ms2\OrgDoc.html --toc
...
#$emacs_dst    = "C:\git\ms1\asset\emacs\"
#$nvim_dst     = "C:\git\ms1\asset\neovim\init.lua"
...
function terminal {
    ...
    $terminal_dst = "C:\git\ms1\asset\terminal\settings.json"
...
function pwsh_profile  {
    ...
    $pwsh_dst      = "C:\git\ms1\asset\Powershell\Microsoft.PowerShell_profile.ps1"
...
# Git-Run
    C:\git\ms1\scripts\Github\ms1u.ps1
Write-Host "Git ms1u Update ✅" -ForegroundColor $FGC
    C:\git\ms1\scripts\Github\ms2u.ps1
